...
const academicAchievements: AchievementCategory[] = [
  {
    title: "পরীক্ষায় ভালো ফলাফল",
    description:
      "বিদ্যালয়ের শিক্ষার্থীরা নিয়মিত ক্লাস, পরিশ্রম ও শিক্ষকদের দিকনির্দেশনায় পরীক্ষায় ভালো ফলাফল অর্জন করে।",
    icon: <FaClipboardCheck />,
  },
  {
    title: "বৃত্তি অর্জন",
    description:
      "মেধাবী শিক্ষার্থীরা বিভিন্ন বৃত্তি পরীক্ষায় অংশগ্রহণ করে সফলতা অর্জন করেছে।",
    icon: <FaAward />,
  },
  {
    title: "মেধা তালিকায় স্থান",
    description:
      "বিদ্যালয়ের শিক্ষার্থীরা শ্রেণি ও বোর্ড পর্যায়ে মেধা তালিকায় স্থান করে প্রতিষ্ঠানের সুনাম বৃদ্ধি করেছে।",
    icon: <FaMedal />,
  },
  {
    title: "বোর্ড পর্যায়ের সাফল্য",
    description:
      "পাবলিক পরীক্ষা ও গুরুত্বপূর্ণ মূল্যায়নে শিক্ষার্থীদের ধারাবাহিক সাফল্য বিদ্যালয়ের মান তুলে ধরে।",
    icon: <FaBookOpen />,
  },
];
...
const coCurricularAchievements: AchievementCategory[] = [
  {
    ...
    description:
      "যুক্তিবোধ, ভাষা দক্ষতা ও আত্মবিশ্বাসের মাধ্যমে শিক্ষার্থীরা বিতর্ক প্রতিযোগিতায় সাফল্য অর্জন করেছে।",
    icon: <FaUsers />,
  },
  {
    title: "বিজ্ঞান মেলা",
    description:
      "সৃজনশীল বিজ্ঞান প্রজেক্ট, উদ্ভাবনী চিন্তা ও বাস্তবভিত্তিক উপস্থাপনার মাধ্যমে শিক্ষার্থীরা প্রশংসিত হয়েছে।",
    icon: <FaFlask />,
  },
  {
    title: "কুইজ প্রতিযোগিতা",
    description:
      "সাধারণ জ্ঞান, বিজ্ঞান, ইতিহাস ও সমসাময়িক বিষয়ভিত্তিক কুইজে শিক্ষার্থীরা ভালো ফলাফল করেছে।",
    icon: <FaRegStar />,
  },
  {
...
const sportsAchievements: HighlightItem[] = [
  {
    ...
    description:
      "দৌড়, লং জাম্প, হাই জাম্প, দলীয় খেলা ও অন্যান্য ক্রীড়া ইভেন্টে শিক্ষার্থীরা অংশগ্রহণ করে পুরস্কার অর্জন করেছে।",
    icon: <FaPersonRunning />,
  },
  {
    title: "আন্তঃস্কুল টুর্নামেন্ট",
    description:
      "ফুটবল, ক্রিকেট ও অন্যান্য দলীয় খেলায় শিক্ষার্থীরা বিদ্যালয়ের প্রতিনিধিত্ব করে সাফল্য অর্জন করেছে।",
    icon: <FaTrophy />,
  },
  {
    title: "অ্যাথলেটিকস সাফল্য",
    description:
      "শারীরিক সক্ষমতা, নিয়মিত অনুশীলন ও দলগত প্রচেষ্টার মাধ্যমে অ্যাথলেটিকস ইভেন্টে ভালো ফলাফল হয়েছে।",
    icon: <FaMedal />,
  },
];
...
const culturalAchievements: HighlightItem[] = [
  {
    title: "গান ও সংগীত",
    description:
      "বিদ্যালয়ের শিক্ষার্থীরা সংগীত প্রতিযোগিতা ও সাংস্কৃতিক অনুষ্ঠানে অংশ নিয়ে প্রশংসা অর্জন করেছে।",
    icon: <FaMasksTheater />,
  },
  {
    title: "নৃত্য ও আবৃত্তি",
    description:
      "সৃজনশীল প্রকাশ, শুদ্ধ উচ্চারণ ও পরিবেশনার মাধ্যমে শিক্ষার্থীরা সাংস্কৃতিক ক্ষেত্রে সাফল্য দেখিয়েছে।",
    icon: <FaStar />,
  },
  {
    title: "নাটক ও মঞ্চ পরিবেশনা",
    description:
      "দলগত অভিনয়, উপস্থাপনা ও সৃজনশীলতার মাধ্যমে শিক্ষার্থীরা মঞ্চ পরিবেশনায় বিশেষ সাফল্য অর্জন করেছে।",
    icon: <FaAward />,
  },
];
...
const achievementItems: AchievementItem[] = [
  {
    id: 1,
    achievementName: "জাতীয় বিজ্ঞান মেলায় সাফল্য",
    category: "বিজ্ঞান",
    studentOrTeam: "বিজ্ঞান ক্লাব দল",
    year: "২০২৬",
    award: "২য় স্থান",
    fileUrl: "#",
  },
  ...
  {
    id: 3,
    achievementName: "বার্ষিক ক্রীড়া প্রতিযোগিতা",
    category: "ক্রীড়া",
    studentOrTeam: "নবম শ্রেণির দল",
    year: "২০২৫",
    award: "সেরা দল",
    fileUrl: "#",
  },
  ...
  {
    id: 5,
    achievementName: "বৃত্তি পরীক্ষায় সফলতা",
    category: "একাডেমিক",
    studentOrTeam: "পঞ্চম শ্রেণির শিক্ষার্থীরা",
    year: "২০২৫",
    award: "বৃত্তি অর্জন",
    fileUrl: "#",
  },
...
const guidelineSections: GuidelineSection[] = [
  {
    ...
    points: [
      ...
      "একাডেমিক পড়াশোনার পাশাপাশি সহশিক্ষা কার্যক্রমেও নিয়মিত অংশগ্রহণ করতে হবে।",
      "দলগত কাজ, সময়ানুবর্তিতা ও শৃঙ্খলা বজায় রেখে বিদ্যালয়ের সুনাম বৃদ্ধি করতে হবে।",
      "অর্জন ধরে রাখতে নিয়মিত অনুশীলন, অধ্যবসায় ও আত্মবিশ্বাস বজায় রাখতে হবে।",
    ],
  },
  {
    ...
    icon: <FaPeopleGroup />,
    points: [
      "সন্তানের আগ্রহ ও প্রতিভা অনুযায়ী একাডেমিক ও সহশিক্ষা কার্যক্রমে অংশগ্রহণে উৎসাহ দিন।",
      "প্রতিযোগিতা, পরীক্ষা ও বিদ্যালয়ের কার্যক্রমের জন্য প্রয়োজনীয় প্রস্তুতিতে সহযোগিতা করুন।",
      "সন্তানের ছোট অর্জনকেও মূল্যায়ন করে আত্মবিশ্বাস বাড়াতে সাহায্য করুন।",
      "অতিরিক্ত চাপ না দিয়ে নিয়মিত অনুশীলন ও শেখার পরিবেশ তৈরি করুন।",
      "বিদ্যালয়ের অর্জন ও কার্যক্রম সম্পর্কে জানতে নিয়মিত নোটিশ ও আপডেট অনুসরণ করুন।",
    ],
  },
];
      ...
      <section className="relative overflow-hidden bg-page-primary px-4 py-14 text-primary sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="relative z-10 mx-auto max-w-[1200px] text-center">
          ...
          <p className="mx-auto mt-7 max-w-3xl text-sm font-semibold leading-8 text-secondary sm:text-base">
            শিক্ষার্থী, শিক্ষক ও প্রতিষ্ঠানের একাডেমিক, সহশিক্ষা, ক্রীড়া,
            সাংস্কৃতিক ও সামাজিক সাফল্যের গল্প এক জায়গায় তুলে ধরার জন্য এই পেজ
            তৈরি করা হয়েছে।
          </p>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-start">
              <div className="lg:col-span-4">
                ...
                <h2 className="mt-3 text-3xl font-black leading-tight text-primary sm:text-4xl">
                  প্রচেষ্টা, অধ্যবসায় ও সাফল্যের গল্প
                </h2>
              ...
              <div className="lg:col-span-8">
                <p className="text-justify text-sm font-semibold leading-8 text-secondary sm:text-base sm:leading-9">
                  বিদ্যালয়ের প্রতিটি অর্জন শিক্ষার্থী, শিক্ষক, অভিভাবক ও
                  কর্তৃপক্ষের সম্মিলিত প্রচেষ্টার ফল। একাডেমিক ফলাফল,
                  সহশিক্ষা কার্যক্রম, বিজ্ঞান, ক্রীড়া, সংস্কৃতি এবং সামাজিক
                  কার্যক্রমে শিক্ষার্থীদের অংশগ্রহণ বিদ্যালয়ের গৌরব বৃদ্ধি করে।
                  এই পেজে আমাদের বিদ্যালয়ের উল্লেখযোগ্য সাফল্য ও অর্জনের
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              <div className="p-6 text-inverse sm:p-8 lg:col-span-8 lg:p-10">
                ...
                <h2 className="mt-5 text-3xl font-black leading-tight sm:text-4xl">
                  জাতীয় পর্যায়ে বিজ্ঞান মেলায় সাফল্য
                </h2>

                <p className="mt-4 text-sm font-semibold leading-8 text-inverse/90 sm:text-base">
                  বিদ্যালয়ের শিক্ষার্থীরা সৃজনশীল বিজ্ঞান প্রজেক্ট উপস্থাপন
                  করে জাতীয় পর্যায়ের বিজ্ঞান মেলায় বিশেষ সাফল্য অর্জন করেছে।
              ...
              <div className="flex items-center justify-center bg-color-secondary p-6 lg:col-span-4 lg:p-10">
                <div className="rounded-[28px] bg-page-primary p-6 text-center shadow-lg">
                  ...
                  <p className="mt-2 text-sm font-semibold leading-6 text-secondary">
                    শিক্ষার্থীদের সাফল্যই আমাদের প্রতিষ্ঠানের গর্ব।
                  </p>
                </div>
              </div>
            </div>
