...
const masterPlanItems: MasterPlanItem[] = [
  {
    ...
    description:
      "প্রতিটি শ্রেণির জন্য পর্যাপ্ত আলো-বাতাসযুক্ত, পরিচ্ছন্ন, প্রশস্ত ও শিক্ষাবান্ধব শ্রেণিকক্ষ তৈরি করা হবে। প্রাথমিক, নিম্ন মাধ্যমিক ও মাধ্যমিক স্তরের জন্য বয়সভিত্তিক আলাদা একাডেমিক জোন রাখা হবে।",
  },
  {
    title: "স্মার্ট ক্লাসরুম ও ডিজিটাল শিক্ষা ব্যবস্থা",
    description:
      "মাল্টিমিডিয়া ক্লাসরুম, ডিজিটাল কনটেন্ট, প্রজেক্টর, স্মার্ট বোর্ড এবং অনলাইন লার্নিং সাপোর্টের মাধ্যমে শিক্ষার্থীদের আধুনিক ও অংশগ্রহণমূলক শিক্ষা নিশ্চিত করা হবে।",
  },
  {
    title: "বিজ্ঞান, আইসিটি ও ইনোভেশন ল্যাব",
    description:
      "পদার্থ, রসায়ন, জীববিজ্ঞান, কম্পিউটার, কোডিং, রোবোটিক্স ও প্রজেক্টভিত্তিক শিক্ষার জন্য নিরাপদ ও আধুনিক ল্যাব স্থাপন করা হবে।",
  },
  {
    title: "লাইব্রেরি ও রিডিং কালচার উন্নয়ন",
    description:
      "নীরব পাঠাগার, রিডিং কর্নার, রেফারেন্স বই, সাহিত্য কর্নার, ই-বুক সুবিধা এবং নিয়মিত বইপাঠ কার্যক্রমের মাধ্যমে শিক্ষার্থীদের জ্ঞানচর্চার পরিবেশ তৈরি করা হবে।",
  },
  {
    title: "নিরাপত্তা ও জরুরি ব্যবস্থাপনা",
    description:
      "ক্যাম্পাসে নিয়ন্ত্রিত প্রবেশদ্বার, ভিজিটর রেজিস্ট্রেশন, সিসিটিভি নজরদারি, নিরাপত্তা কর্মী, অগ্নি নির্বাপণ ব্যবস্থা এবং জরুরি বহির্গমন পথ নিশ্চিত করা হবে।",
  },
  {
    title: "স্বাস্থ্য, পরিচ্ছন্নতা ও স্যানিটেশন",
    description:
      "বিশুদ্ধ পানি, স্বাস্থ্যসম্মত টয়লেট, হাত ধোয়ার স্থান, ফার্স্ট এইড কর্নার, নিয়মিত পরিচ্ছন্নতা এবং স্বাস্থ্য সচেতনতা কার্যক্রম পরিচালনা করা হবে।",
  },
  {
  ...
  },
  {
    ...
    description:
      "বৃক্ষরোপণ, বাগান, বর্জ্য ব্যবস্থাপনা,プラスチックমুক্ত ক্যাম্পাস, সৌরবিদ্যুৎ ব্যবহার এবং বৃষ্টির পানি সংরক্ষণের মাধ্যমে পরিবেশবান্ধব ক্যাম্পাস গড়ে তোলা হবে।",
  },
];
...
const phaseItems: PhaseItem[] = [
  {
    phase: "প্রথম этап",
    title: "প্রাথমিক অবকাঠামো উন্নয়ন",
    description:
      "শ্রেণিকক্ষ, অফিস, নিরাপত্তা গেট, টয়লেট, বিশুদ্ধ পানি, বিদ্যুৎ, আসবাবপত্র এবং মৌলিক ক্যাম্পাস সুবিধা নিশ্চিত করা।",
  },
  {
    phase: "দ্বিতীয় этап",
  ...
  {
    phase: "তৃতীয় этап",
    title: "পূর্ণাঙ্গ ক্যাম্পাস উন্নয়ন",
    description:
      "খেলার মাঠ, অডিটোরিয়াম, গ্রিন ক্যাম্পাস, ডিজিটাল ম্যানেজমেন্ট, পরিবহন সুবিধা এবং ভবিষ্যৎ সম্প্রসারণ পরিকল্পনা বাস্তবায়ন।",
  },
];
      ...
      <section className="mx-auto max-w-[1600px] px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:py-14">
       ...
       মাস্টার প্ল্যান
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base font-medium leading-7 text-secondary sm:text-lg">
            ...
            শিক্ষাবান্ধব ক্যাম্পাস গড়ে তোলার জন্য আমাদের দীর্ঘমেয়াদী
            পরিকল্পনা।
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="p-6 text-inverse sm:p-8 lg:col-span-8 lg:p-10">
              ...
              <p className="mt-5 max-w-4xl text-justify text-base font-medium leading-8 text-white/85 sm:text-lg">
                ...
                নয়; এটি শিক্ষার্থীদের একাডেমিক শিক্ষা, নিরাপত্তা, স্বাস্থ্য,
                প্রযুক্তি দক্ষতা, সহশিক্ষা কার্যক্রম, মানসিক বিকাশ এবং
                ভবিষ্যৎ নেতৃত্ব গঠনের একটি পূর্ণাঙ্গ উন্নয়ন পরিকল্পনা। এই
                পরিকল্পনার মাধ্যমে আমরা এমন একটি ক্যাম্পাস গড়ে তুলতে চাই,
                যেখানে প্রতিটি শিক্ষার্থী নিরাপদ, আনন্দময় ও অনুপ্রেরণামূলক
                পরিবেশে বেড়ে উঠবে।
              </p>
            </div>
        ...
        <section className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-stretch">
          <article className="rounded-3xl border border-soft bg-page-primary p-6 shadow-xl transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-2xl sm:p-8 lg:col-span-6">
            ...
            <div className="mt-6 rounded-2xl border-l-4 border-brand-primary bg-page-secondary p-5">
              <p className="text-justify text-lg font-bold leading-8 text-brand-primary">
                ...
                গড়ে তোলা, যেখানে প্রতিটি শিক্ষার্থী জ্ঞান, দক্ষতা, नैतिकতা ও
                আত্মবিশ্বাস নিয়ে বেড়ে উঠবে।”
              </p>
            </div>
          ...
          <article className="rounded-3xl border border-soft bg-page-primary p-6 shadow-xl transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-2xl sm:p-8 lg:col-span-6">
            ...
            <p className="mt-6 text-justify text-base font-medium leading-8 text-secondary sm:text-lg">
              শিক্ষার্থীদের বয়স, নিরাপত্তা, পাঠদানের ধরন, মানসিক বিকাশ,
              শারীরিক সুস্থতা এবং ভবিষ্যৎ দক্ষতা বিবেচনা করে প্রতিটি
              অবকাঠামো পরিকল্পনা করা হবে। একই সঙ্গে শিক্ষক, অভিভাবক ও
              প্রশাসনের মধ্যে সমন্বিত যোগাযোগ ব্যবস্থা গড়ে তোলা হবে।
            </p>
        ...
        {/* বিস্তারিত মাস্টার প্ল্যান আইটেমসমূহ */}
        ...
        <section className="mt-10 rounded-3xl bg-color-primary p-6 text-inverse shadow-2xl sm:p-8 lg:p-10">
          ...
          <p className="mt-4 max-w-3xl text-base font-medium leading-8 text-white/85 sm:text-lg">
            স্কুলের উন্নয়ন কার্যক্রম ধাপে ধাপে বাস্তবায়ন করা হবে, যাতে
            শিক্ষার পরিবেশ ব্যাহত না হয় এবং প্রতিটি সুবিধা পরিকল্পিতভাবে
            কার্যকর করা যায়।
          </p>
