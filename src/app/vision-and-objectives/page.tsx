...
const missionItems: MissionItem[] = [
  {
    ...
    description:
      "ছাত্রীদের জন্য নিরাপদ, পরিচ্ছন্ন, glassware ও সম্মানজনক ক্যাম্পাস পরিবেশ তৈরি করা, যেখানে তারা আত্মবিশ্বাসের সাথে শিক্ষা গ্রহণ করতে পারে।",
  },
  {
    title: "আধুনিক ও মানসম্মত একাডেমিক শিক্ষা প্রদান",
    description:
      "বাংলা, ইংরেজি, গণিত, বিজ্ঞান, আইসিটি ও মানবিক শিক্ষার সমন্বয়ে যুগোপযোগী পাঠদান, নিয়মিত মূল্যায়ন এবং দক্ষ শিক্ষক-শিক্ষিকার মাধ্যমে শিক্ষার মান নিশ্চিত করা।",
  },
  {
    title: "নৈতিকতা, শৃঙ্খলা ও মানবিক মূল্যবোধ গঠন",
    description:
      "ছাত্রীদের মধ্যে ভদ্রতা, সময়নিষ্ঠা, আত্মসম্মান, পারস্পরিক শ্রদ্ধা, দেশপ্রেম, সততা ও মানবিক আচরণ গড়ে তুলতে নিয়মিত নৈতিক শিক্ষা ও সহশিক্ষা কার্যক্রম পরিচালনা করা।",
  },
  {
    title: "বিজ্ঞান, আইসিটি ও জীবনদক্ষতা উন্নয়ন",
    description:
  ...
  {
    title: "স্বাস্থ্য, পরিচ্ছন্নতা ও মানসিক সহায়তা",
    description:
      "ছাত্রীদের জন্য স্বাস্থ্যসম্মত স্যানিটেশন, বিশুদ্ধ পানি, স্যানিটারি হাইজিন সচেতনতা, ফার্স্ট এইড, কাউন্সেলিং এবং কৈশোরকালীন স্বাস্থ্য সহায়তা নিশ্চিত করা।",
  },
  {
    title: "অভিভাবক যোগাযোগ ও শিক্ষার্থী অগ্রগতি পর্যবেক্ষণ",
    description:
      "উপস্থিতি, ফলাফল, আচরণ, সহশিক্ষা অংশগ্রহণ ও শিক্ষার অগ্রগতি নিয়মিত পর্যবেক্ষণ করে অভিভাবকদের সাথে কার্যকর যোগাযোগ বজায় রাখা।",
  },
];
    ...
    <main className="min-h-screen bg-page-secondary font-main text-primary">
      ...
      Mission & Vision
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base font-medium leading-7 text-secondary sm:text-lg">
            নিরাপদ, আধুনিক, নৈতিক ও ছাত্রীবান্ধব শিক্ষার পরিবেশ গড়ে তোলার
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="p-6 text-inverse sm:p-8 lg:col-span-8 lg:p-10">
              ...
              <p className="mt-5 max-w-4xl text-justify text-base font-medium leading-8 text-white/85 sm:text-lg">
                আমরা believe করি, একটি বালিকা বিদ্যালয়ের প্রকৃত সফলতা শুধু
                ভালো ফলাফলের মধ্যে সীমাবদ্ধ নয়; বরং প্রতিটি ছাত্রীকে নিরাপদ,
                আত্মবিশ্বাসী, সৃজনশীল, শৃঙ্খলাবদ্ধ এবং মানবিক মানুষ হিসেবে
                গড়ে তোলাই প্রকৃত শিক্ষা। তাই আমাদের শিক্ষা কার্যক্রমে
                একাডেমিক উৎকর্ষতার পাশাপাশি নৈতিকতা, স্বাস্থ্য সচেতনতা,
                নেতৃত্ব, প্রযুক্তি দক্ষতা এবং সামাজিক দায়িত্ববোধকে বিশেষ
                গুরুত্ব দেওয়া হয়।
              </p>
            </div>
          ...
          <article className="order-2 rounded-3xl border border-soft bg-page-primary p-6 shadow-xl sm:p-8 lg:order-1 lg:col-span-7">
            ...
            <div className="mt-6 rounded-2xl border-l-4 border-brand-primary bg-page-secondary p-5">
              <p className="text-justify text-lg font-bold leading-8 text-brand-primary">
                ...
                ছাত্রীকে আত্মবিশ্বাসী, সুশিক্ষিত, দায়িত্বশীল ও মানবিক নাগরিক
                হিসেবে গড়ে তোলা।”
              </p>
            </div>

            <p className="mt-6 text-justify text-base font-medium leading-8 text-secondary sm:text-lg">
              আমাদের ভিশন হলো এমন একটি বালিকা বিদ্যালয় গড়ে তোলা, যেখানে
              শিক্ষার্থীরা নিরাপদ পরিবেশে জ্ঞান অর্জন করবে, নিজের প্রতিভা
              বিকাশ করবে এবং ভবিষ্যতের জন্য প্রয়োজনীয় দক্ষতা অর্জন করবে।
              শিক্ষার্থীদের মধ্যে আত্মসম্মান, নেতৃত্ব, নৈতিকতা, দেশপ্রেম,
              সৃজনশীলতা এবং সামাজিক দায়িত্ববোধ গড়ে তোলাই আমাদের প্রধান লক্ষ্য।
            </p>
          </article>

          <div className="order-1 lg:order-2 lg:col-span-5">
            <SectionImage src="/assets/3.jpg" alt="বিদ্যালয়ের ভিশন চিত্র" />
          </div>
        </section>
