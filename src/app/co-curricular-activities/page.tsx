            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-start">
              <div className="lg:col-span-4">
                ...
                <h2 className="mt-3 text-3xl font-black leading-tight text-primary sm:text-4xl">
                  पढ़াশোনার পাশাপাশি পূর্ণ বিকাশ
                </h2>
              ...
              <div className="lg:col-span-8">
                <p className="text-justify text-sm font-semibold leading-8 text-secondary sm:text-base sm:leading-9">
                  সহশিক্ষা কার্যক্রম শিক্ষার্থীদের পাঠ্যবইয়ের বাইরের জগৎকে
                  জানার সুযোগ করে দেয়। খেলাধুলা, সংস্কৃতি, বিতর্ক, বিজ্ঞান,
                  প্রযুক্তি, শিল্প ও সামাজিক কার্যক্রমের মাধ্যমে শিক্ষার্থীদের
                  আত্মবিশ্বাস, নেতৃত্বগুণ, সৃজনশীলতা এবং সামাজিক দায়িত্ববোধ
                  গড়ে ওঠে। একটি সুন্দর বিদ্যালয় পরিবেশে সহশিক্ষা কার্যক্রম
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              <div className="p-6 text-inverse sm:p-8 lg:col-span-8 lg:p-10">
                ...
                <p className="mt-4 text-sm font-semibold leading-8 text-inverse/90 sm:text-base">
                  ...
                  আত্মবিশ্বাস, নেতৃত্ব, সৃজনশীলতা এবং সামাজিক দায়িত্ববোধ গড়ে
                  তোলে। শিক্ষক, শিক্ষার্থী ও অভিভাবকদের সহযোগিতায় বিদ্যালয়ের
                  সহশিক্ষা কার্যক্রম আরও প্রাণবন্ত ও ফলপ্রসূ হয়ে ওঠে।
                </p>
              </div>
